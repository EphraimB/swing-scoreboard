...
**Center.java**: Manages the GUI's center panel, displays greeting text, creates separate score objects for both the home and away teams, adds them to the center panel, and provides getter methods so the other classes can access score components.
...
**ConsolePrint.java**: Prints the scores to the console.
